  ...
  return (
    <>
      ...
      <div className="mt-10 grid grid-cols-3 auto-rows-auto gap-6">
        <div
          onClick={() => {
            setActiveTeacher("allTeacher");
            setActive("Date & Time");
          }}
          className="h-44 text-neutral-500 cursor-pointer bg-lime-50 shadow-md border border-lime-300 flex flex-col justify-center items-center rounded-xl"
        >
